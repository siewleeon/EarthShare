          ...
          children: [
            ...
            FutureBuilder(
              ...
              builder: (context, AsyncSnapshot<List<QuerySnapshot>> snapshot) {
                ...
                final transactionDocs = snapshot.data![0].docs;
                final productDocs = snapshot.data![1].docs;
            ...
            FutureBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                totalUsers > 0 ? (totalPurchases / totalUsers).round() : 0;
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            averagePurchasePerUser.toString(),
                            style: const TextStyle(
                              color: Colors.white,
                              fontSize: 20,
                            ),
